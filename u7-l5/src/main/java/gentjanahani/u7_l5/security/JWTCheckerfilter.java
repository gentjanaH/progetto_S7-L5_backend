...
public class JWTCheckerfilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JWTCheckerfilter(CreateAndVerify createAndVerify, UtenteService utenteService) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        //------------------------AUTORIZZAZIONE------------------
        //Prima leggiamo l'id
        UUID idUtente = createAndVerify.extractIdFromToken(accessToken);
        Utente utenteAutenticato = this.utenteService.findUtenteById(idUtente);
